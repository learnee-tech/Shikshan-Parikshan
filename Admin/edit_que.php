...
<?php 
                    $query="select * from career_que where w1='".$code."' or w2='".$code."' or w3='".$code."' or w4='".$code."'";
        ...
        <table class="table table-striped">
            <thead>
               <button type='submit' class='btn btn-outline-success' data-toggle='modal' data-target='#addQue' name='add_que' value='add_que' >
                    Add Question (Weightage)  
                </button>
                &emsp; &emsp; &emsp; &emsp;
                <button type='submit' class='btn btn-outline-success' data-toggle='modal' data-target='#addQuewt' name='add_que_wt' value='add_que_wt' >
                    Add Question (Without Weightage) 
                </button>
                
                <button type='submit' class='btn btn-outline-success' data-toggle='modal' data-target='#add_normal' name='add_normal' value='add_normal' >
                    Add Question 
                </button>
                
                <button type='submit' class='btn btn-outline-success' data-toggle='modal' data-target='#addQue2opt' name='add_normal1' value='add_normal1' >
                    Add Question 
                </button>
...
while($cur=$res->fetch_assoc())
{
    ...
    if (isset($_REQUEST['delete'])) {
        ...
        $sql = "DELETE FROM `questions` WHERE `Id` =  '$e_id' ";
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="form-group">
                      ...
                      <div class="form-group">
            			<div class="row">
              				<label class="col-md-4 text-right">Add After <span class="text-danger">*</span></label>
	              			<div class="col-md-8">
	                			<select name="after" id="total_question" required class="form-control">
	                				<option value="">Select</option>
	                				
	                				<option value="12">After 12th</option>
	                				<option value="10">After 10th</option>
	                			</select>
	                		</div>
            			</div>
                      </div>
