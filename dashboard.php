...
$sid=$_SESSION['school_id'];
   $query = "select * from school_data where school_id='$sid'";
                    ...
                    while($cur=$res1->fetch_assoc())
{
       ...
       echo "
       <input type='hidden' name='career_code' value='".$cur['class_nm']."'>
        <td>
    ...
    $con= new mysqli('localhost','root','','vigorous_coders');
        $sql = "DELETE FROM `career` WHERE `class_nm` =  '$e_id' ";
    $sql1 = "DELETE FROM `school_data` WHERE `class_nm` =  '$e_id' ";
            ...
            <div class="modal-content">
                ...
                <div class="form-group">
            			<div class="row">
	              			...
	              			<div class="col-md-8">
                        <input type="text" class="form-control" required name="class_nm" id="exam_name">
                    </div>
            			</div>
                </div>
                ...
                <div class="modal-footer">
                <input type="hidden" name="action" id="action" value="Add" />
                <button type="submit" name="add_class" class="btn btn-success" id="submit_form_id" >Add</button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                </div>
...
// end date fetch from modal for add exam
    ...
    if(isset($_POST['action']) == 'Add')
    {
        ...
        $query = "INSERT INTO `school_data`(`school_id`, `class_nm`) VALUES ($s_id,'$code')";
